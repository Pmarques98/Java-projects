...
public class VerificaExecao {
	List<br.usp.ime.mac321.ep2.ex2.Usuario> usuarios;
	List<br.usp.ime.mac321.ep2.ex2.Livro> livros;
	List<br.usp.ime.mac321.ep2.ex2.Exemplar> exemplares;
	List<br.usp.ime.mac321.ep2.ex2.Emprestimo> emprestimos;
	
	public VerificaExecao(List<br.usp.ime.mac321.ep2.ex2.Usuario> usuarios2, List<br.usp.ime.mac321.ep2.ex2.Livro> livros2, List<br.usp.ime.mac321.ep2.ex2.Exemplar> exemplares2, List<br.usp.ime.mac321.ep2.ex2.Emprestimo> emprestimos2) {
		this.emprestimos = emprestimos2;
		this.exemplares = exemplares2;
		this.livros = livros2;
